...
const Home = () => {
  ...
  useEffect(() => {
    const options = {
      root: null,
      rootMargin: '0px',
      threshold: 0.3 // Trigger when 60% of the section is in view
    };
      ...
      <div className="home-container">
        <div className="content-container">
          <div className="menu">
            ...
            <a href='https://github.com/AlecMoore' target="_blank" rel="noopener noreferrer">
              ...
              <a href='https://www.linkedin.com/in/alec-moore-2853261b6' target="_blank" rel="noopener noreferrer">
